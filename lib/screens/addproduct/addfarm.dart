...
class _AddFarmState extends State<AddFarm> {
  ...
  String selectedItem = 'Big Machinery';
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    String? uid = user.uid;
   String id = _reference.doc("Farm").collection(selectedItem.toString()).doc().id;
    // Do something when payment succeeds
    _reference.doc("Farm").collection(selectedItem.toString()).doc(id).set({
      "image1": image1Url,
      "image2": image2Url,
      "image3": image3Url,
      "image4": image4Url,
