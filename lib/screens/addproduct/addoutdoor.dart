...
class _OutdoorState extends State<Outdoor> {
  ...
  final TextEditingController _controllerDeposit = TextEditingController();
  ...
  String selectedItem = 'Construction';
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    String itemName = _controllerName.text;
                                ...
                                String? uid = user.uid;
                                String id = _reference.doc("Outdoor").collection(selectedItem.toString()).doc().id;
    // Do something when payment succeeds
    _reference.doc("Outdoor").collection(selectedItem.toString()).doc(id).set({
      "image1": image1Url,
      "image2": image2Url,
      "image3": image3Url,
      "image4": image4Url,
...
Navigator.push(context,
  ...
  void _handlePaymentError(PaymentFailureResponse response) {
      Navigator.push(context,
                            MaterialPageRoute(builder: (_) => const failed()));
