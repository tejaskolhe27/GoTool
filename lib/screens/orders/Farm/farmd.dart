...
import 'package:farmer_app/screens/orders/Farm/speciald.dart';
import 'package:flutter/material.dart';

class Farmd extends StatefulWidget {
  const Farmd({super.key});

  @override
  State<Farmd> createState() => _FarmdState();
}

class _FarmdState extends State<Farmd> {
  @override
              ...
              Padding(
                ...
                child: Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.of(context).pushReplacement(
                            MaterialPageRoute(builder: (context) =>Speciald()));
                      },
                      child: Column(
