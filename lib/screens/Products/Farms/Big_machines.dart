...
class Big_Machines extends StatelessWidget {
  Big_Machines({Key? key}) : super(key: key) {
    _stream = FirebaseFirestore.instance
        .collection('Products')
        .doc("Farm")
        .collection("Big Machinery").where("uid", isNotEqualTo: FirebaseAuth.instance.currentUser!.uid)
